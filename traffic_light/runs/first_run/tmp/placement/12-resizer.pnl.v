module light (Green,
 ...
 sky130_fd_sc_hd__and2b_1 _17_ (.A_N(\state[0] ),
    .B(\state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _18_ (.A(_08_),
    ...
    .VPWR(VPWR),
    .X(_00_));
 sky130_fd_sc_hd__and2b_1 _19_ (.A_N(\state[1] ),
    .B(\state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 _20_ (.A(_09_),
    ...
    .VPWR(VPWR),
    .X(_15_));
 sky130_fd_sc_hd__nor2_1 _21_ (.A(\state[1] ),
    .B(\state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_16_));
 sky130_fd_sc_hd__nand2_1 _22_ (.A(\count3[0] ),
    .B(\count3[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_10_));
 sky130_fd_sc_hd__a21o_1 _23_ (.A1(\state[1] ),
    .A2(\state[0] ),
    .B1(_10_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_02_));
 sky130_fd_sc_hd__a21boi_1 _24_ (.A1(\state[1] ),
    .A2(\state[0] ),
    .B1_N(_10_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_03_));
 sky130_fd_sc_hd__nor2_1 _25_ (.A(_00_),
    .B(_15_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _29_ (.A(_12_),
    ...
    .VPWR(VPWR),
    .X(_05_));
 sky130_fd_sc_hd__nor2_1 _30_ (.A(\count3[0] ),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_06_));
 sky130_fd_sc_hd__or2_1 _31_ (.A(\count3[0] ),
    .B(\count3[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_13_));
 sky130_fd_sc_hd__and3b_1 _32_ (.A_N(net1),
    .B(_10_),
    .C(_13_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_14_));
 sky130_fd_sc_hd__clkbuf_1 _33_ (.A(_14_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_07_));
 sky130_fd_sc_hd__dfxtp_1 _34_ (.CLK(clk),
    .D(_04_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dlxtn_1 _40_ (.D(_15_),
    ...
    .VPWR(VPWR),
    .Q(\nextstate[1] ));
 sky130_fd_sc_hd__dfxtp_1 _41_ (.CLK(clk),
    .D(_06_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\count3[0] ));
 sky130_fd_sc_hd__dfxtp_1 _42_ (.CLK(clk),
    .D(_07_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
